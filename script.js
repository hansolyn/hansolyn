const questions = [
  ...
  // 안정 변화
  { question: "프로젝트 진행 중반에 기가 막힌 아이디어가 떠올랐다.<br><br>처음 세운 계획대로 하기 vs 실시간으로 반영하여 계획변경", options: ["계획", "변경"], score: [1, -1], category: "안정 변화" },
  { question: "인사평가 결과와 상관없이 매년 3%씩 연봉인상 vs 인사평가 결과에 따라 매년 0~10% 연봉인상", options: ["3%", "0~10%"], score: [1, -1], category: "안정 변화" },
  { question: "매주 월요일 9시에 업무보고하기 vs 이슈 있을 때마다 보고하기", options: ["정기보고", "수시보고"], score: [1, -1], category: "안정 변화" },
  
  // 복지 돈
  { question: "연봉 외 식권(회사근처 편의점, 카페, 식당 사용가능) 연320만원 지급 vs 연봉에 식대(비과세) 240만원 추가", options: ["식권", "연봉"], score: [1, -1], category: "복지 돈" },
  ...
  { question: "프로젝트가 성공적으로 마무리되어 인센티브가 나온다고 한다.<br><br>기여도에 따라 다르게 받기 vs 똑같이 나눠받기", options: ["기여도에 따라", "N분의 1"], score: [1, -1], category: "개인과 조직" },
