const questions = [
  ...
  // 안정 변화
  { question: "프로젝트 진행 중반에 기가 막힌 아이디어가 떠올랐는데,<br>처음 세운 계획대로 하기 vs 실시간으로 반영하여 계획변경", options: ["계획", "변경"], score: [1, -1], category: "안정 변화" },
  ...
  { question: "프로젝트가 성공적으로 마무리되어 성과급을 준다는데,<br>기여도에 따라 다르게 받기 vs 똑같이 나눠받기", options: ["기여도에 따라", "N분의 1"], score: [1, -1], category: "개인과 조직" },
